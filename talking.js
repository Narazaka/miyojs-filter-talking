...
MiyoFilters.talking_initialize = function(argument, request, id, stash) {
  var timeout, _ref;
  timeout = 25;
  if (((_ref = argument.talking_initialize) != null ? _ref.timeout : void 0) != null) {
...
MiyoFilters.talking_begin = function(argument, request, id, stash) {
...
MiyoFilters.talking_end = function(argument, request, id, stash) {
  clearTimeout(this.variables_temporary.talking_timer);
  this.variables_temporary.talking = false;
  return '';
};

MiyoFilters.talking = function(value, request, id, stash) {
